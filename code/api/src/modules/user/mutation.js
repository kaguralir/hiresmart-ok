...
export async function userStartNow({ auth }) {
  ...
  if (authCheck(auth)) {
    ...
    try {
      ...
      console.log("new demo org is", organization);
      ...
      console.log("There was some error while connecting to start now. Please try again.", error);
      throw new Error(`There was some error while connecting to start now. Please try again.`)
    }
  }
}
